...
class BootScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.loadingBarConstants.x =
      (this.game.scale.displaySize.width - this.loadingBarConstants.width) / 2;
    this.loadingBarConstants.y =
      (this.game.scale.displaySize.height - this.loadingBarConstants.height) /
      2;
    ...
    this.load.on('progress', value => {
      ...
      progressBar.fillRect(
        ...
        (this.loadingBarConstants.width -
          2 * this.loadingBarConstants.padding) *
          value,
    ...
    this.load.spritesheet('Character1SpriteSheet', Character1SpriteSheet, {
      frameWidth: 60,
      frameHeight: 82,
      endFrame: 144,
    });
    this.load.spritesheet('Character2SpriteSheet', Character2SpriteSheet, {
      frameWidth: 60,
      frameHeight: 82,
      endFrame: 144,
    });
    this.load.spritesheet('Character3SpriteSheet', Character3SpriteSheet, {
      frameWidth: 60,
      frameHeight: 82,
      endFrame: 144,
    });
    this.load.spritesheet('Character4SpriteSheet', Character4SpriteSheet, {
      frameWidth: 60,
      frameHeight: 82,
      endFrame: 144,
    });
    this.load.spritesheet('LeakSpriteSheet', LeakSpriteSheet, {
      frameWidth: 60,
      frameHeight: 60,
      endFrame: 34,
    });
    this.load.spritesheet('ElectroSpriteSheet', ElectroSpriteSheet, {
      frameWidth: 60,
      frameHeight: 60,
      endFrame: 34,
    });
    this.load.spritesheet('HoleSpriteSheet', HoleSpriteSheet, {
      frameWidth: 60,
      frameHeight: 60,
      endFrame: 34,
    });
    this.load.spritesheet('FireSpriteSheet', FireSpriteSheet, {
      frameWidth: 60,
      frameHeight: 60,
      endFrame: 34,
    });
    ...
    this.load.spritesheet('EngineDoorSpriteSheet', EngineDoorSpriteSheet, {
      frameWidth: 88,
      frameHeight: 122,
      endFrame: 32,
    });
    ...
    this.load.audio('FireExtinguisherSound', [
      FireExtinguisherSoundMP3,
      FireExtinguisherSoundOGG,
    ]);
    this.load.audio('HammerSound', [HammerSoundMP3, HammerSoundOGG]);
    this.load.audio('HoleSound', [HoleSoundMP3, HoleSoundOGG]);
    this.load.audio('SolderingIronSound', [
      SolderingIronSoundMP3,
      SolderingIronSoundOGG,
    ]);
    ...
    this.load.audio('CharacterWalkSound', [
      CharacterWalkSoundMP3,
      CharacterWalkSoundOGG,
    ]);
    this.load.audio('EngineAddCoalSound', [
      EngineAddCoalSoundMP3,
      EngineAddCoalSoundOGG,
    ]);
    this.load.audio('ItemDropSound', [ItemDropSoundMP3, ItemDropSoundOGG]);
    this.load.audio('ItemPickUpSound', [
      ItemPickUpSoundMP3,
      ItemPickUpSoundOGG,
    ]);
